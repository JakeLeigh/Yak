    ...
    return (
      <div class='meetTeam'>
       <div class='teamMemberDiv'>
        <img data-aos="fade-right" src={Woman1} class='teamImg'/>
        <div data-aos='fade-left' class='teamMemberContent1'>
       ...
       <div class='teamMemberDiv'>
        <div data-aos="fade-right" class='teamMemberContent2'>
        ...
        <img data-aos="fade-left" src={Woman2} class='teamImg'/>
       </div>
      </div>
    )
  }
